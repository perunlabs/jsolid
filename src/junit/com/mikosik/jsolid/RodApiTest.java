...
public class RodApiTest {
  ...
  @Test
  public void negative_section_length_throws_exception() throws Exception {
    when(() -> rod(3).section(-1, 1));
    thenThrown(IllegalArgumentException.class);
  }

  @Test
  public void negative_section_length_without_radius_throws_exception() throws Exception {
    when(() -> rod(3).section(-1));
    thenThrown(IllegalArgumentException.class);
  }
